...
function formatSnakeRecord(record, displayName = "") {
...
async function refreshSnakeLeaderboard(snapshotValue) {
    ...
    firebaseLeaderboard = firebaseLeaderboard.filter(Boolean);
